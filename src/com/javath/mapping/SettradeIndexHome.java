...
public class SettradeIndexHome {
    ...
    public SettradeIndex merge(SettradeIndex detachedInstance) {
        ...
        try {
            SettradeIndex result = (SettradeIndex) sessionFactory.getCurrentSession()
    ...
    public SettradeIndex findById( com.javath.mapping.SettradeIndexId id) {
        ...
        try {
            SettradeIndex instance = (SettradeIndex) sessionFactory.getCurrentSession()
                    .get("com.javath.mapping.SettradeIndex", id);
            if (instance==null) {
    ...
    public List<SettradeIndex> findByExample(SettradeIndex instance) {
        ...
        try {
            List<SettradeIndex> results = (List<SettradeIndex>) sessionFactory.getCurrentSession()
