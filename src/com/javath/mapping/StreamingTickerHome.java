...
public class StreamingTickerHome {
	...
	public StreamingTicker merge(StreamingTicker detachedInstance) {
		...
		try {
			StreamingTicker result = (StreamingTicker) sessionFactory
	...
	public StreamingTicker findById(com.javath.mapping.StreamingTickerId id) {
		...
		try {
			StreamingTicker instance = (StreamingTicker) sessionFactory
					.getCurrentSession().get(
							"com.javath.mapping.StreamingTicker", id);
			if (instance == null) {
	...
	public List<StreamingTicker> findByExample(StreamingTicker instance) {
		...
		try {
			List<StreamingTicker> results = (List<StreamingTicker>) sessionFactory
					.getCurrentSession()
