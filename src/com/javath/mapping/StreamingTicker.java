...
public class StreamingTicker  implements java.io.Serializable {
    ...
    public StreamingTicker(StreamingTickerId id, Short type, Short n, Date time, String side, Double price, Double close, Double change, Double changePercent, String a, String b, Integer volume, String symbol) {
       this.id = id;
       this.type = type;
       this.n = n;
       this.time = time;
