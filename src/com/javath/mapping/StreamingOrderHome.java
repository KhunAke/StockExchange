...
public class StreamingOrderHome {
    ...
    public StreamingOrder merge(StreamingOrder detachedInstance) {
        ...
        try {
            StreamingOrder result = (StreamingOrder) sessionFactory.getCurrentSession()
    ...
    public StreamingOrder findById( com.javath.mapping.StreamingOrderId id) {
        ...
        try {
            StreamingOrder instance = (StreamingOrder) sessionFactory.getCurrentSession()
                    .get("com.javath.mapping.StreamingOrder", id);
            if (instance==null) {
    ...
    public List<StreamingOrder> findByExample(StreamingOrder instance) {
        ...
        try {
            List<StreamingOrder> results = (List<StreamingOrder>) sessionFactory.getCurrentSession()
