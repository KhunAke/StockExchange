...
/**
 * StreamingOrderId generated by hbm2java
 */
public class StreamingOrderId  implements java.io.Serializable {


     private String symbol;
     private Date date;

    public StreamingOrderId() {
    }

    public StreamingOrderId(String symbol, Date date) {
       this.symbol = symbol;
       this.date = date;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof StreamingOrderId) ) return false;
		 StreamingOrderId castOther = ( StreamingOrderId ) other; 
