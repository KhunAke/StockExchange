...
/**
 * BualuangBoardHistoryId generated by hbm2java
 */
public class BualuangBoardHistoryId  implements java.io.Serializable {


     private String symbol;
     private Date date;

    public BualuangBoardHistoryId() {
    }

    public BualuangBoardHistoryId(String symbol, Date date) {
       this.symbol = symbol;
       this.date = date;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BualuangBoardHistoryId) ) return false;
		 BualuangBoardHistoryId castOther = ( BualuangBoardHistoryId ) other; 
