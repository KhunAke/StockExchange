...
public class IndicatorRsiHome {
    ...
    public IndicatorRsi merge(IndicatorRsi detachedInstance) {
        ...
        try {
            IndicatorRsi result = (IndicatorRsi) sessionFactory.getCurrentSession()
    ...
    public IndicatorRsi findById( com.javath.mapping.IndicatorRsiId id) {
        ...
        try {
            IndicatorRsi instance = (IndicatorRsi) sessionFactory.getCurrentSession()
                    .get("com.javath.mapping.IndicatorRsi", id);
            if (instance==null) {
    ...
    public List<IndicatorRsi> findByExample(IndicatorRsi instance) {
        ...
        try {
            List<IndicatorRsi> results = (List<IndicatorRsi>) sessionFactory.getCurrentSession()
