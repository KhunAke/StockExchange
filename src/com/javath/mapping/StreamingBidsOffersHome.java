...
public class StreamingBidsOffersHome {
    ...
    private static final Log log = LogFactory.getLog(StreamingBidsOffersHome.class);
    ...
    public StreamingBidsOffers merge(StreamingBidsOffers detachedInstance) {
        ...
        try {
            StreamingBidsOffers result = (StreamingBidsOffers) sessionFactory.getCurrentSession()
    ...
    public StreamingBidsOffers findById( com.javath.mapping.StreamingBidsOffersId id) {
        log.debug("getting StreamingBidsOffers instance with id: " + id);
        try {
            StreamingBidsOffers instance = (StreamingBidsOffers) sessionFactory.getCurrentSession()
                    .get("com.javath.mapping.StreamingBidsOffers", id);
            if (instance==null) {
    ...
    public List<StreamingBidsOffers> findByExample(StreamingBidsOffers instance) {
        ...
        try {
            List<StreamingBidsOffers> results = (List<StreamingBidsOffers>) sessionFactory.getCurrentSession()
