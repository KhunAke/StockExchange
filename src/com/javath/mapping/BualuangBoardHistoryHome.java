...
// Generated Aug 4, 2013 4:58:20 PM by Hibernate Tools 4.0.0
...
public class BualuangBoardHistoryHome {
    ...
    private static final Log log = LogFactory.getLog(BualuangBoardHistoryHome.class);
    ...
    public BualuangBoardHistory merge(BualuangBoardHistory detachedInstance) {
        ...
        try {
            BualuangBoardHistory result = (BualuangBoardHistory) sessionFactory.getCurrentSession()
    ...
    public BualuangBoardHistory findById( com.javath.mapping.BualuangBoardHistoryId id) {
        log.debug("getting BualuangBoardHistory instance with id: " + id);
        try {
            BualuangBoardHistory instance = (BualuangBoardHistory) sessionFactory.getCurrentSession()
                    .get("com.javath.mapping.BualuangBoardHistory", id);
            if (instance==null) {
    ...
    public List<BualuangBoardHistory> findByExample(BualuangBoardHistory instance) {
        log.debug("finding BualuangBoardHistory instance by example");
        try {
            List<BualuangBoardHistory> results = (List<BualuangBoardHistory>) sessionFactory.getCurrentSession()
